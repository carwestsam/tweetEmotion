...
if __name__ == "__main__":
    ...
    if 'run' in __type:
        ...
        if __type == 'Unigram_run':
            DictDir = '../emojiOutput/UnigramDict'
            loop_ofilename = '../emojiOutput/test_feautre_emoji_'
            loop_lfilename = '../Compare_Output/test_ans_emoji_'
            all_ofilename = '../emojiOutput/test_feautre_emoji_all'
            all_lfilename = '../Compare_Output/test_ans_emoji_all'
        elif __type == 'UnigramHash_run':
            DictDir = '../emojiOutput/UnigramHashtagDict'
            loop_ofilename = '../emojiOutput/test_feautre_unihash_'
            loop_lfilename = '../Compare_Output/test_ans_unihash_'
            all_ofilename = '../emojiOutput/test_feautre_unihash_all'
            all_lfilename = '../Compare_Output/test_ans_unihash_all'
        elif __type == 'UnigramEmoticon_run':
            DictDir = '../emojiOutput/UnigramEmoticonDict'
            loop_ofilename = '../emojiOutput/test_feautre_uniemo_'
            loop_lfilename = '../Compare_Output/test_ans_uniemo_'
            all_ofilename = '../emojiOutput/test_feautre_uniemo_all'
            all_lfilename = '../Compare_Output/test_ans_uniemo_all'
        load_Index()


        for Emo in divideByEmoji_test.Emotions:
            ifilename = divideByEmoji_test.OutputDir + Emo['name']
        ...
        ifilename = '../emojiOutput/test_featre_all'
        dts.setSize( 100000 )
