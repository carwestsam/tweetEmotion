...
OutputDir = '../emojiOutput/labeled_by_emoji_'
...
if __name__ == "__main__":
    dts.setSize( 1000000 )
    dts.setFile( '../emojiOutput/afterPre.txt','../emojiOutput/featre_all', '../log/labeled_by_emoji_log' )
    dts.openFiles()
    ...
    hashfile = codecs.open( '../emojiOutput/hashtagList_emoji', 'w', 'utf-8' )

    print hashtagSet
    hashfile.write( json.dumps( list(hashtagSet )) + u'\n' )
