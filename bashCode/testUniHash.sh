...
function fun_all()
{
    ...
    echo "./svm-train -s $1 -t $2 -q /home/server2103/tweetEmotion/emojiOutput/$TRAIN_ALL /home/server2103/tweetEmotion/Compare_Output/"$MODEL_ALL"_"$1"_"$2
    ./svm-train -s $1 -t $2 -q /home/server2103/tweetEmotion/emojiOutput/$TRAIN_ALL /home/server2103/tweetEmotion/Compare_Output/$MODEL_ALL"_"$1"_"$2
    wait
